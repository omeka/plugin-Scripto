...
(<a href="<?php echo html_escape(url('scripto/index/logout')); ?>">logout</a>) 
 | <a href="<?php echo html_escape(url('scripto/watchlist')); ?>">Your watchlist</a> 
<?php else: ?>
<a href="<?php echo html_escape(url('scripto/index/login')); ?>">Log in to Scripto</a>
<?php endif; ?>
 ...
 | <a href="<?php echo html_escape(url(array('item-id' => $this->doc->getId(), 'file-id' => $this->doc->getPageId(), 'namespace-index' => $this->namespaceIndex), 'scripto_history')); ?>">View history</a>
</p> 
